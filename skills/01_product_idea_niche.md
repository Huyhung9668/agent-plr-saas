...
## Purpose
Điều phối và sinh nội dung cho Step 1: Product Idea / Niche trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 1` / `Bước 1` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 1 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 1 — Product Idea / Niche
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 01_product_idea_niche
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 1

## Files To Create/Update
- No fixed file; write response/report as requested.

## Quality Checklist
- [ ] Đúng Step 1, không route sang step khác.
...
Step 1 Product Idea / Niche cho product hiện tại.`
- `product idea cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 1 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
