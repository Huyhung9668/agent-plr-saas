# Buyer Simulation Test

## Purpose
Điều phối và sinh nội dung cho Step 17: Buyer Simulation Test trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 17` / `Bước 17` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 17 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 17 — Buyer Simulation Test
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 17_buyer_simulation_test
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 17

## Files To Create/Update
- `buyer_simulation_test.md`

## Quality Checklist
- [ ] Đúng Step 17, không route sang step khác.
...
Step 17 Buyer Simulation Test cho product hiện tại.`
- `buyer test cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 17 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
