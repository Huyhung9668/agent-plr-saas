# Templates / CSV / Worksheets

## Purpose
Điều phối và sinh nội dung cho Step 6: Templates / CSV / Worksheets trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 6` / `Bước 6` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 6 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 6 — Templates / CSV / Worksheets
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 06_templates_csv_worksheets
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 6

## Files To Create/Update
- `step_6_templates_csv_worksheets/`

## Quality Checklist
- [ ] Đúng Step 6, không route sang step khác.
...
Step 6 Templates / CSV / Worksheets cho product hiện tại.`
- `templates cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 6 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
