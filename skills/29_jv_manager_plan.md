...
## Purpose
Điều phối và sinh nội dung cho Step 29: JV Manager Plan trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 29` / `Bước 29` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 29 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 29_jv_manager_plan
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 29

## Files To Create/Update
- `jv_manager_plan.md`

## Quality Checklist
- [ ] Đúng Step 29, không route sang step khác.
...
Step 29 JV Manager Plan cho product hiện tại.`
- `jv manager plan cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 29 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
