# Sales Page Claim Audit

## Purpose
Điều phối và sinh nội dung cho Step 27: Sales Page Claim Audit trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 27` / `Bước 27` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 27 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 27 — Sales Page Claim Audit
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 27_sales_page_claim_audit
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 27

## Files To Create/Update
- `sales_page_claim_audit.md`

## Quality Checklist
- [ ] Đúng Step 27, không route sang step khác.
...
Step 27 Sales Page Claim Audit cho product hiện tại.`
- `claim audit cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 27 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
