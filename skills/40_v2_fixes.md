...
## Purpose
Điều phối và sinh nội dung cho Step 40: V2 Fixes trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 40` / `Bước 40` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 40 hoặc keyword match.
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 40

## Files To Create/Update
- `v2_fixes.md`

## Quality Checklist
- [ ] Đúng Step 40, không route sang step khác.
...
Step 40 V2 Fixes cho product hiện tại.`
- `v2 fixes cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 40 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
