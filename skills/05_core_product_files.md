...
## Purpose
Điều phối và sinh nội dung cho Step 5: Core Product Files trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 5` / `Bước 5` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 5 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 5 — Core Product Files
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 05_core_product_files
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 5

## Files To Create/Update
- `step_5_core_product_files/`

## Quality Checklist
- [ ] Đúng Step 5, không route sang step khác.
...
Step 5 Core Product Files cho product hiện tại.`
- `core product files cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 5 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
