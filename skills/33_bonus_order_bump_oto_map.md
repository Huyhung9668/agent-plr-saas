# Bonus / Order Bump / OTO Map

## Purpose
Điều phối và sinh nội dung cho Step 33: Bonus / Order Bump / OTO Map trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 33` / `Bước 33` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 33 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 33 — Bonus / Order Bump / OTO Map
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 33_bonus_order_bump_oto_map
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 33

## Files To Create/Update
- `bonus_order_bump_oto_map.md`

## Quality Checklist
- [ ] Đúng Step 33, không route sang step khác.
...
Step 33 Bonus / Order Bump / OTO Map cho product hiện tại.`
- `bonus cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 33 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
