...
## Purpose
Điều phối và sinh nội dung cho Step 9: Quality Checklist trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 9` / `Bước 9` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 9 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 09_quality_checklist
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 9

## Files To Create/Update
- `step_9_quality_checklist/`

## Quality Checklist
- [ ] Đúng Step 9, không route sang step khác.
...
Step 9 Quality Checklist cho product hiện tại.`
- `quality checklist cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 9 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
