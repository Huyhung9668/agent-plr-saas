...
## Purpose
Điều phối và sinh nội dung cho Step 10: License / Compliance trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 10` / `Bước 10` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 10 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 10 — License / Compliance
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 10_license_compliance
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 10

## Files To Create/Update
- `step_10_license_compliance/`

## Quality Checklist
- [ ] Đúng Step 10, không route sang step khác.
...
Step 10 License / Compliance cho product hiện tại.`
- `license cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 10 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
