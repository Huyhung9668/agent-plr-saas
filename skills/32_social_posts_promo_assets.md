# Social Posts / Promo Assets

## Purpose
Điều phối và sinh nội dung cho Step 32: Social Posts / Promo Assets trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 32` / `Bước 32` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 32 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 32 — Social Posts / Promo Assets
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 32_social_posts_promo_assets
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 32

## Files To Create/Update
- `social_posts_promo_assets.md`

## Quality Checklist
- [ ] Đúng Step 32, không route sang step khác.
...
Step 32 Social Posts / Promo Assets cho product hiện tại.`
- `social posts cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 32 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
