...
## Purpose
Điều phối và sinh nội dung cho Step 3: Product Decision trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 3` / `Bước 3` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 3 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 03_product_decision
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 3

## Files To Create/Update
- No fixed file; write response/report as requested.

## Quality Checklist
- [ ] Đúng Step 3, không route sang step khác.
...
Step 3 Product Decision cho product hiện tại.`
- `product decision cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 3 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
