...
## Purpose
Điều phối và sinh nội dung cho Step 14: AI Replace Risk Audit trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 14` / `Bước 14` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 14 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 14 — AI Replace Risk Audit
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 14_ai_replace_risk_audit
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 14

## Files To Create/Update
- `ai_replace_risk_audit.md`

## Quality Checklist
- [ ] Đúng Step 14, không route sang step khác.
...
Step 14 AI Replace Risk Audit cho product hiện tại.`
- `ai replace risk cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 14 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
