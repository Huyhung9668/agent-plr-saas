...
## Purpose
Điều phối và sinh nội dung cho Step 12: Product Core Review trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 12` / `Bước 12` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 12 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 12 — Product Core Review
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 12_product_core_review
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 12

## Files To Create/Update
- `product_core_review.md`

## Quality Checklist
- [ ] Đúng Step 12, không route sang step khác.
...
Step 12 Product Core Review cho product hiện tại.`
- `product core review cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 12 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
