...
## Purpose
Điều phối và sinh nội dung cho Step 7: Prompt Library trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 7` / `Bước 7` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 7 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 07_prompt_library
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 7

## Files To Create/Update
- `step_7_prompt_library/`

## Quality Checklist
- [ ] Đúng Step 7, không route sang step khác.
...
Step 7 Prompt Library cho product hiện tại.`
- `prompt library cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 7 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
