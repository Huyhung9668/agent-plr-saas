...
## Purpose
Điều phối và sinh nội dung cho Step 21: Add More Example Outputs trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 21` / `Bước 21` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 21 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 21 — Add More Example Outputs
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 21_add_more_example_outputs
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 21

## Files To Create/Update
- `more_example_outputs.md`

## Quality Checklist
- [ ] Đúng Step 21, không route sang step khác.
...
Step 21 Add More Example Outputs cho product hiện tại.`
- `more example outputs cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 21 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
