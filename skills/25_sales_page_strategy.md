...
## Purpose
Điều phối và sinh nội dung cho Step 25: Sales Page Strategy trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 25` / `Bước 25` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 25 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 25 — Sales Page Strategy
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 25_sales_page_strategy
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 25

## Files To Create/Update
- `sales_page_strategy.md`

## Quality Checklist
- [ ] Đúng Step 25, không route sang step khác.
...
Step 25 Sales Page Strategy cho product hiện tại.`
- `sales page strategy cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 25 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
