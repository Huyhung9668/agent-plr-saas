# Soft Launch / Review Access

## Purpose
Điều phối và sinh nội dung cho Step 37: Soft Launch / Review Access trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 37` / `Bước 37` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 37 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 37 — Soft Launch / Review Access
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 37_soft_launch_review_access
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 37

## Files To Create/Update
- `soft_launch_plan.md`

## Quality Checklist
- [ ] Đúng Step 37, không route sang step khác.
...
Step 37 Soft Launch / Review Access cho product hiện tại.`
- `soft launch cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 37 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
