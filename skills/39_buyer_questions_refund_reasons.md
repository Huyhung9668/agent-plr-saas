# Buyer Questions / Refund Reasons

## Purpose
Điều phối và sinh nội dung cho Step 39: Buyer Questions / Refund Reasons trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 39` / `Bước 39` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 39 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 39 — Buyer Questions / Refund Reasons
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 39_buyer_questions_refund_reasons
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 39

## Files To Create/Update
- `buyer_questions_refund_reasons.md`

## Quality Checklist
- [ ] Đúng Step 39, không route sang step khác.
...
Step 39 Buyer Questions / Refund Reasons cho product hiện tại.`
- `buyer questions cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 39 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
