...
## Purpose
Điều phối và sinh nội dung cho Step 22: Add Checklists trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 22` / `Bước 22` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 22 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 22_add_checklists
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 22

## Files To Create/Update
- `checklists.md`

## Quality Checklist
- [ ] Đúng Step 22, không route sang step khác.
...
Step 22 Add Checklists cho product hiện tại.`
- `add checklists cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 22 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
