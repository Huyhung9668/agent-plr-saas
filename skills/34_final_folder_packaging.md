...
## Purpose
Điều phối và sinh nội dung cho Step 34: Final Folder Packaging trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 34` / `Bước 34` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 34 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 34 — Final Folder Packaging
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 34_final_folder_packaging
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 34

## Files To Create/Update
- `final_folder_packaging.md`

## Quality Checklist
- [ ] Đúng Step 34, không route sang step khác.
...
Step 34 Final Folder Packaging cho product hiện tại.`
- `final folder packaging cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 34 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
