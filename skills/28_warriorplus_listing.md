...
## Purpose
Điều phối và sinh nội dung cho Step 28: WarriorPlus Listing trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 28` / `Bước 28` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 28 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 28 — WarriorPlus Listing
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 28_warriorplus_listing
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 28

## Files To Create/Update
- `warriorplus_listing.md`

## Quality Checklist
- [ ] Đúng Step 28, không route sang step khác.
...
Step 28 WarriorPlus Listing cho product hiện tại.`
- `warriorplus listing cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 28 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
