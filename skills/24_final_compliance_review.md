...
## Purpose
Điều phối và sinh nội dung cho Step 24: Final Compliance Review trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 24` / `Bước 24` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 24 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 24 — Final Compliance Review
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 24_final_compliance_review
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 24

## Files To Create/Update
- `final_compliance_review.md`

## Quality Checklist
- [ ] Đúng Step 24, không route sang step khác.
...
Step 24 Final Compliance Review cho product hiện tại.`
- `final compliance review cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 24 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
