...
## Purpose
Điều phối và sinh nội dung cho Step 23: Add Fix Prompts trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 23` / `Bước 23` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 23 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 23_add_fix_prompts
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 23

## Files To Create/Update
- `fix_prompts.md`

## Quality Checklist
- [ ] Đúng Step 23, không route sang step khác.
...
Step 23 Add Fix Prompts cho product hiện tại.`
- `fix prompts cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 23 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
