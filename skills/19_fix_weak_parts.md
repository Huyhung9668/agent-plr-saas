...
## Purpose
Điều phối và sinh nội dung cho Step 19: Fix Weak Parts trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 19` / `Bước 19` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 19 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 19_fix_weak_parts
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 19

## Files To Create/Update
- `weak_parts_fix_log.md`

## Quality Checklist
- [ ] Đúng Step 19, không route sang step khác.
...
Step 19 Fix Weak Parts cho product hiện tại.`
- `fix weak parts cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 19 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
