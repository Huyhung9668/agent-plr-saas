# OTO Decision hoặc SP2 Decision

## Purpose
Điều phối và sinh nội dung cho Step 44: OTO Decision hoặc SP2 Decision trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 44` / `Bước 44` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 44 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 44 — OTO Decision hoặc SP2 Decision
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 44_oto_decision_sp2_decision
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 44

## Files To Create/Update
- `oto_decision_sp2_decision.md`

## Quality Checklist
- [ ] Đúng Step 44, không route sang step khác.
...
Step 44 OTO Decision hoặc SP2 Decision cho product hiện tại.`
- `oto decision cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 44 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
