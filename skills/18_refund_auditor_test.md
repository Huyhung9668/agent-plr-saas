...
## Purpose
Điều phối và sinh nội dung cho Step 18: Refund Auditor Test trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 18` / `Bước 18` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 18 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 18 — Refund Auditor Test
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 18_refund_auditor_test
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 18

## Files To Create/Update
- `refund_auditor_test.md`

## Quality Checklist
- [ ] Đúng Step 18, không route sang step khác.
...
Step 18 Refund Auditor Test cho product hiện tại.`
- `refund risk cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 18 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
