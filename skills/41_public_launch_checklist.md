...
## Purpose
Điều phối và sinh nội dung cho Step 41: Public Launch Checklist trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 41` / `Bước 41` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 41 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 41 — Public Launch Checklist
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 41_public_launch_checklist
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 41

## Files To Create/Update
- `public_launch_checklist.md`

## Quality Checklist
- [ ] Đúng Step 41, không route sang step khác.
...
Step 41 Public Launch Checklist cho product hiện tại.`
- `public launch checklist cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 41 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
