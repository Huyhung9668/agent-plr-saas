# Support / Refund / Affiliate Tracking

## Purpose
Điều phối và sinh nội dung cho Step 43: Support / Refund / Affiliate Tracking trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 43` / `Bước 43` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 43 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 43 — Support / Refund / Affiliate Tracking
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 43_support_refund_affiliate_tracking
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 43

## Files To Create/Update
- `support_refund_affiliate_tracking.md`

## Quality Checklist
- [ ] Đúng Step 43, không route sang step khác.
...
Step 43 Support / Refund / Affiliate Tracking cho product hiện tại.`
- `support tracking cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 43 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
