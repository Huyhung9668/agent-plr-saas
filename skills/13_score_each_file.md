...
## Purpose
Điều phối và sinh nội dung cho Step 13: Chấm điểm từng file trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 13` / `Bước 13` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 13 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 13 — Chấm điểm từng file
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 13_score_each_file
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 13

## Files To Create/Update
- `file_by_file_scorecard.md`

## Quality Checklist
- [ ] Đúng Step 13, không route sang step khác.
...
Step 13 Chấm điểm từng file cho product hiện tại.`
- `chấm điểm từng file cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 13 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
