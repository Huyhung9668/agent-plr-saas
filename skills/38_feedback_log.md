...
## Purpose
Điều phối và sinh nội dung cho Step 38: Feedback Log trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 38` / `Bước 38` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 38 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 38_feedback_log
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 38

## Files To Create/Update
- `feedback_log.md`

## Quality Checklist
- [ ] Đúng Step 38, không route sang step khác.
...
Step 38 Feedback Log cho product hiện tại.`
- `feedback log cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 38 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
