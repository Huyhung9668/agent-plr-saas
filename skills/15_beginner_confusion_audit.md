# Beginner Confusion Audit

## Purpose
Điều phối và sinh nội dung cho Step 15: Beginner Confusion Audit trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 15` / `Bước 15` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 15 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 15 — Beginner Confusion Audit
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 15_beginner_confusion_audit
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 15

## Files To Create/Update
- `beginner_confusion_audit.md`

## Quality Checklist
- [ ] Đúng Step 15, không route sang step khác.
...
Step 15 Beginner Confusion Audit cho product hiện tại.`
- `beginner confusion cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 15 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
