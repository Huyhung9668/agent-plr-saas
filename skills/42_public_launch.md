...
## Purpose
Điều phối và sinh nội dung cho Step 42: Public Launch trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 42` / `Bước 42` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 42 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 42_public_launch
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 42

## Files To Create/Update
- `public_launch.md`

## Quality Checklist
- [ ] Đúng Step 42, không route sang step khác.
...
Step 42 Public Launch cho product hiện tại.`
- `public launch cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 42 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
