...
## Purpose
Điều phối và sinh nội dung cho Step 31: Affiliate Email Swipes trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 31` / `Bước 31` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 31 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 31 — Affiliate Email Swipes
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 31_affiliate_email_swipes
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 31

## Files To Create/Update
- `affiliate_email_swipes.md`

## Quality Checklist
- [ ] Đúng Step 31, không route sang step khác.
...
Step 31 Affiliate Email Swipes cho product hiện tại.`
- `affiliate email cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 31 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
