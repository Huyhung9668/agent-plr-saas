...
## Purpose
Điều phối và sinh nội dung cho Step 20: Re-score Product trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 20` / `Bước 20` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 20 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 20_rescore_product
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 20

## Files To Create/Update
- `product_rescore_report.md`

## Quality Checklist
- [ ] Đúng Step 20, không route sang step khác.
...
Step 20 Re-score Product cho product hiện tại.`
- `rescore cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 20 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
