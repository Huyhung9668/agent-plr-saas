...
## Purpose
Điều phối và sinh nội dung cho Step 30: JV Page / JV Invite trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 30` / `Bước 30` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 30 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 30 — JV Page / JV Invite
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 30_jv_page_jv_invite
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 30

## Files To Create/Update
- `jv_page_jv_invite.md`

## Quality Checklist
- [ ] Đúng Step 30, không route sang step khác.
...
Step 30 JV Page / JV Invite cho product hiện tại.`
- `jv page cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 30 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
