...
## Purpose
Điều phối và sinh nội dung cho Step 8: Examples / Sample Outputs trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 8` / `Bước 8` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 8 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 8 — Examples / Sample Outputs
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 08_examples_sample_outputs
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 8

## Files To Create/Update
- `step_8_examples_sample_outputs/`

## Quality Checklist
- [ ] Đúng Step 8, không route sang step khác.
...
Step 8 Examples / Sample Outputs cho product hiện tại.`
- `examples cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 8 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
