...
## Purpose
Điều phối và sinh nội dung cho Step 4: Product Blueprint trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 4` / `Bước 4` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 4 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 04_product_blueprint
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 4

## Files To Create/Update
- No fixed file; write response/report as requested.

## Quality Checklist
- [ ] Đúng Step 4, không route sang step khác.
...
Step 4 Product Blueprint cho product hiện tại.`
- `blueprint cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 4 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
