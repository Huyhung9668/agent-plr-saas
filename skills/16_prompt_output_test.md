...
## Purpose
Điều phối và sinh nội dung cho Step 16: Prompt Output Test trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 16` / `Bước 16` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 16 hoặc keyword match.
...
```txt
PRODUCT USED:
STEP USED: 16 — Prompt Output Test
FILES USED:
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 16_prompt_output_test
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 16

## Files To Create/Update
- `prompt_output_test.md`

## Quality Checklist
- [ ] Đúng Step 16, không route sang step khác.
...
Step 16 Prompt Output Test cho product hiện tại.`
- `prompt output test cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 16 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
