...
## Purpose
Điều phối và sinh nội dung cho Step 26: Sales Page Copy trong hệ thống WarriorPlus AI Printables/KDP/PLR Product Builder.

## When To Use
Dùng khi user gọi rõ `Step 26` / `Bước 26` hoặc dùng intent tự nhiên khớp với skill này.
...
1. Xác nhận explicit step = 26 hoặc keyword match.
...
NEXT FIX:
REQUEST DEBUG:
- selected_skill: 26_sales_page_copy
...
## Files To Read
- `project_state.json`
- Active project markdown/csv/txt files needed for Step 26

## Files To Create/Update
- `sales_page_copy.md`

## Quality Checklist
- [ ] Đúng Step 26, không route sang step khác.
...
Step 26 Sales Page Copy cho product hiện tại.`
- `sales page copy cho active project, chấm điểm và nêu missing assets.`
- `Hỏi Step 26 mà trả step khác là lỗi gì? Debug route, không dùng mẫu cũ.`
