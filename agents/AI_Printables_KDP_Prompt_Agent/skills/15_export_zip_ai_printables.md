...
## Purpose
Package real product files into ZIP with manifest and placeholder check.

## When To Use
Use for export, zip, package/export zip, manifest.
...
- quality_gates/PUBLIC_LAUNCH_GATE.md
...
## Quality Rules
- ZIP missing => FAIL.
- Important placeholders => Public Launch Gate FAIL.
...
## Example Trigger
#ai-printables #kdp #export-zip Run Export ZIP AI Printables for this product or niche.
