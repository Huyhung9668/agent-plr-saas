...
## Purpose
Create JV invite, affiliate swipes, social posts, promo rules.

## When To Use
Use for JV, affiliate, affiliate swipes.
...
- brain/WARRIORPLUS_PATTERNS.md
- brain/SALES_PATTERNS.md
- brain/LICENSE_COMPLIANCE_RULES.md
...
## Quality Rules
- Affiliate copy must be compliant.
- Must include cannot-claim list.
...
## Example Trigger
#ai-printables #kdp #jv-pack Run JV Pack AI Printables for this product or niche.
