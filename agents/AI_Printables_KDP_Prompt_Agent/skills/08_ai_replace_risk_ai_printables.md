...
## Purpose
Audit whether buyer thinks ChatGPT can replace the product.

## When To Use
Use for can ChatGPT do this too, AI replace risk.
...
- quality_gates/AI_REPLACE_RISK_GATE.md
...
- Risk level:
- High-risk sections:
- Why AI can replace this:
- Assets to add:
- Workflow needed:
- Examples needed:
- Checklist needed:
- Fix prompts needed:
- Final risk after fix:
- Next Action:

## Quality Rules
- Only prompts/templates => HIGH.
- Must specify concrete assets to reduce risk.
...
## Example Trigger
#ai-printables #kdp #ai-replace-risk Run AI Replace Risk AI Printables for this product or niche.
