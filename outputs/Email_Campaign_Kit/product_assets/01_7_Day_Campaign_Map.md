...
This file gives **Email Campaign Kit** its real product depth. A beginner campaign should not be a random stack of templates. Every email needs a job. If every email only says "buy this", the campaign feels pushy. If every email only teaches, the reader may never know what to do next.
