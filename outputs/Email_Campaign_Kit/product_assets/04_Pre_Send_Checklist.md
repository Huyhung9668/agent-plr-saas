...
Use this checklist before sending any email created from **Email Campaign Kit**. A template is not ready just because it reads well. It must be clear, safe, specific, and aligned with the campaign goal.
